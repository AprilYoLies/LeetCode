...
public class AVLTree<T extends Comparable<T>> {
    ...
    public void iterativeInOrder(AVLTreeNode tree) {
        ...
        while (tree != null) {
            ...
            if (tree == null) {
                tree = stack.pop();
                System.out.print(tree.key + " ");
                while (!stack.empty() && tree.right == null) {
                    tree = stack.pop();
                    System.out.print(tree.key + " ");
                }
                if (tree.right == null) {
    ...
    public void iterativeInOrder() {
        iterativeInOrder(this.mRoot);
    }

    public void iterativePreOrder(AVLTreeNode tree) {

        Stack<AVLTreeNode> stack = new Stack<>();
        AVLTreeNode p = null;
//        Queue<AVLTreeNode> queue = new LinkedBlockingQueue<>();
        while (tree != null) {
            System.out.print(tree.key + " ");
            if (tree.left != null) {
                stack.push(tree);
    ...
    void iterativePreOrder() {
        iterativePreOrder(this.mRoot);
    }


    private void iterativePostOrder(AVLTreeNode node) {
        if (node == null)
            return;
        Stack<AVLTreeNode> s = new Stack<AVLTreeNode>();
        Set<AVLTreeNode> visited = new HashSet<>();

        AVLTreeNode curNode; //当前访问的结点
        AVLTreeNode lastVisitNode; //上次访问的结点
        curNode = node;
        lastVisitNode = null;
