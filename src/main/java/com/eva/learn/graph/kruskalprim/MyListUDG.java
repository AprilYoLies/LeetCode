...
public class MyListUDG {
	 ...
	 */
	public MyListUDG(char[] vexs, EData[] edges) {
	...
	public static void main(String[] args) {
		...
		EData[] edges = {
				...
				new EData('F', 'B', 7), new EData('C', 'D', 3), new EData('C', 'E', 5), new EData('C', 'F', 6),
